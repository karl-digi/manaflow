...
export async function runSimpleAnthropicReviewStream(
  ...
  // Configure the appropriate AI provider based on model choice
  ...
  const selectedModel =
    model === "openai-ft0"
      ? openai("ft:gpt-4.1-mini-2025-04-14:lawrence:cmux-heatmap-sft:CZW6Lc77")
