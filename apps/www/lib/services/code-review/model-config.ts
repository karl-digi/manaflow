...
export const HEATMAP_MODEL_OPUS_4_5_QUERY_VALUE = "opus-4-5";
export type HeatmapModelQueryValue =
  ...
  | typeof HEATMAP_MODEL_OPUS_4_5_QUERY_VALUE;
...
export function getHeatmapModelConfigForSelection(
  ...
  if (selection === HEATMAP_MODEL_OPUS_4_5_QUERY_VALUE) {
    return createAnthropicOpus45Config();
  }
...
export function normalizeHeatmapModelQueryValue(
  ...
  if (typeof raw !== "string") {
    return HEATMAP_MODEL_OPUS_4_5_QUERY_VALUE;
  }
  const normalized = raw.trim().toLowerCase();
  if (normalized === HEATMAP_MODEL_OPUS_4_5_QUERY_VALUE) {
    return HEATMAP_MODEL_OPUS_4_5_QUERY_VALUE;
  }
