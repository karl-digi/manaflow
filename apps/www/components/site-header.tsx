...
export function SiteHeader({
  ...
  const formattedStarCount = useMemo(() => {
    if (typeof githubStars !== "number" || Number.isNaN(githubStars)) {
      return null;
    }
        ...
        <div className="flex items-center gap-3">
          ...
          {githubUrl ? (
            <a
              ...
              className="group hidden h-[30px] items-center gap-1.5 rounded-md border border-white/15 px-3 text-xs font-mono text-neutral-300 transition hover:border-white/30 hover:bg-white/10 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/60 md:inline-flex"
              href={githubUrl}
              rel="noopener noreferrer"
              target="_blank"
