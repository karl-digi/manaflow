                            ...
                            <div className="relative flex items-center justify-between px-4 py-3">
                              ...
                              <div className="flex items-center gap-2">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 text-[9px] text-neutral-300 hover:text-white"
                                >
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-3">
                                  <h1 className="text-white text-base font-semibold leading-tight">
                                    Universal AI coding agent manager for 10x
                                    engineers
                                  </h1>
                                  <p className="text-[9px] text-neutral-300 leading-relaxed">
                                    cmux is a universal AI coding agent manager
                                    that supports Claude Code, Codex, Gemini
                                    CLI, Amp, Opencode, and other coding CLIs.
                                  </p>
                                  <p className="text-[9px] text-neutral-300 leading-relaxed">
                                    Every run spins up an isolated VS Code
                                    workspace either in the cloud or in a local
                                    Docker container with the git diff view,
                                    terminal, and dev server preview ready.
                                  </p>
                                  <div className="flex items-center gap-2 pt-2">
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="px-2 py-1 bg-white text-black text-[8px] rounded-lg flex items-center gap-1 font-medium hover:bg-neutral-200"
                                    >
                                      <svg
                                    ...
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="px-2 py-1 border border-white/10 bg-white/5 text-white text-[8px] rounded-lg flex items-center gap-1 hover:bg-white/10"
                                    >
                                      GitHub repo
                                  ...
                                  <div className="rounded-xl border border-white/10 bg-white/5 p-2">
                                    ...
                                    <div className="space-y-1.5">
                                      <div className="flex gap-2">
                                        ...
                                        <div>
                                          <p className="text-[8px] text-white font-medium">
                                            Run multiple agent CLIs side-by-side
                                          </p>
                                          <p className="text-[7px] text-neutral-400">
                                            Claude Code, Codex, Gemini CLI, Amp,
                                            and more.
                                          </p>
                                        </div>
                                      </div>
                                      <div className="flex gap-2">
                                        ...
                                        <div>
                                          <p className="text-[8px] text-white font-medium">
                                            Dedicated VS Code instance per agent
                                          </p>
                                          <p className="text-[7px] text-neutral-400">
                                            Isolated VS Code, terminal, and git
                                            diff view.
                                          </p>
                                        </div>
                                      </div>
                                      <div className="flex gap-2">
                                        ...
                                        <div>
                                          ...
                                          <p className="text-[7px] text-neutral-400">
                                            Browser previews to verify dev
                                            server output.
                                          </p>
                                        </div>
                                      </div>
                              ...
                              <div className="mt-4 rounded-lg overflow-hidden border border-white/10 bg-neutral-900 h-[100px]">
                                <div className="flex h-full">
                                  ...
                                  <div className="flex-1 bg-neutral-900 p-2">
                                    <div className="text-[6px] text-neutral-500 text-center">
                                      cmux dashboard preview
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-4">
                              ...
                              <p className="text-sm text-neutral-300 leading-relaxed">
                                cmux is a universal AI coding agent manager that
                                supports Claude Code, Codex, Gemini CLI, Amp,
                                Opencode, and other coding CLIs.
                              </p>
                              <p className="text-sm text-neutral-300 leading-relaxed">
                                Every run spins up an isolated VS Code workspace
                                either in the cloud or in a local Docker
                                container with the git diff view, terminal, and
                                dev server preview ready.
                              </p>
                              <div className="flex items-center gap-3 pt-2">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-4 py-2 bg-white text-black text-sm rounded-lg flex items-center gap-2 font-medium hover:bg-neutral-200"
                                >
                                  <svg
                                    className="h-4 w-4"
                                    viewBox="0 0 16 16"
                                ...
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-4 py-2 border border-white/10 bg-white/5 text-white text-sm rounded-lg flex items-center gap-2 hover:bg-white/10"
                                >
                                  GitHub repo
                                ...
                                <div className="space-y-2">
                                  <div className="flex gap-3">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-xs text-neutral-400">
                                        Claude Code, Codex, Gemini CLI, Amp, and
                                        more.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex gap-3">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-xs text-neutral-400">
                                        Isolated VS Code, terminal, and git diff
                                        view.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex gap-3">
                                    ...
                                    <div>
                                      <p className="text-sm text-white font-medium">
                                        Preview environments for verification
                                      </p>
                                      <p className="text-xs text-neutral-400">
                                        Browser previews to verify dev server
                                        output.
                                      </p>
                                    </div>
                                  </div>
