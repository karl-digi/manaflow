...
For each line (added, removed, or unchanged), append a review tag in the format:
<original line> // review <score:0-1> "<most_important_phrase>" <optional comment>
- Use lowercase "review".
- Replace spaces in the phrase with underscores so it stays a single token.
- Always include a score (0-1) even if the line is fine.
- Keep the phrase short (1-4 words).
