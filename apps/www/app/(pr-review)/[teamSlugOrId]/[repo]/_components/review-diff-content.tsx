    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <div
            key={index}
            className="h-32 rounded-xl border border-neutral-200 bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-900"
          />
        ))}
      </div>
    </div>
...
export function ErrorPanel({
  ...
  return (
    <div className="rounded-xl border border-rose-200 bg-rose-50 p-6 text-sm text-rose-700 dark:border-rose-700 dark:bg-rose-950 dark:text-rose-200">
