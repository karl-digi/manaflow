...
/usr/libexec/PlistBuddy -c "Set :CFBundleIdentifier $APP_ID" "$APP_DIR/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion $APP_VERSION" "$APP_DIR/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString $APP_VERSION" "$APP_DIR/Contents/Info.plist"

# Register custom URL scheme so macOS knows to open this app for deep links
...
/usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:0:CFBundleURLName string $CMUX_PROTOCOL" "$APP_DIR/Contents/Info.plist" 2>/dev/null || true
/usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:0:CFBundleURLSchemes array" "$APP_DIR/Contents/Info.plist" 2>/dev/null || true
/usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:0:CFBundleURLSchemes:0 string $CMUX_PROTOCOL" "$APP_DIR/Contents/Info.plist" 2>/dev/null || true
...
APP_UPDATE_SRC="$(pwd)/electron/app-update.next.yml"
