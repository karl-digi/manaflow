...
const TASK_RUN_LOCAL_WORKSPACE_PREFIX = "task-run-local-workspace:";
...
export function getTaskRunLocalWorkspacePersistKey(taskRunId: string): string {
  return `${TASK_RUN_LOCAL_WORKSPACE_PREFIX}${taskRunId}`;
}
