...
import { AlertTriangle, Check, ChevronDown, ChevronRight, Loader2, Minus, Plus } from "lucide-react";
import {
  useCallback,
  useEffect,
  useMemo,
      ...
      >
        <div className="inline-flex items-center gap-1.5 pt-1 font-medium text-xs text-neutral-600 hover:text-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-200">
          ...
          {configQuery.isPending ? (
            <Loader2 className="w-3.5 h-3.5 text-neutral-600 dark:text-neutral-400 animate-spin" />
          ) : isConfigured ? (
