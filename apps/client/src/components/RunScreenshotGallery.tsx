          ...
          >
            <Dialog.Portal>
              <Dialog.Overlay
                ...
                className="fixed inset-0 cursor-pointer bg-neutral-950/70 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out"
              />
              <Dialog.Content
                className="fixed inset-0 flex items-center justify-center p-4 sm:p-8 focus:outline-none"
                onPointerDown={(event) => {
              ...
              >
                <div className="relative flex w-full max-w-[90vw] flex-col gap-4 rounded-2xl border border-neutral-200 bg-white/95 p-4 shadow-2xl focus:outline-none dark:border-neutral-800 dark:bg-neutral-950/90 sm:p-6">
                  ...
                  <div className="flex flex-1 items-center justify-center gap-4">
                    ...
                    <div className="relative flex w-full flex-1 items-center justify-center rounded-xl border border-neutral-200 bg-neutral-50 p-3 shadow-inner max-h-[82vh] min-h-[50vh] sm:min-h-[60vh] dark:border-neutral-800 dark:bg-neutral-900">
                      <img
                        src={currentEntry.image.url ?? undefined}
                        alt={currentEntry.image.fileName ?? "Screenshot"}
                        className="h-full w-full max-h-[calc(82vh-2rem)] max-w-full object-contain"
                      />
                    </div>
                    {flattenedImages.length > 1 ? (
                      <button
