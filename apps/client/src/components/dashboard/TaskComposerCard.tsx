...
export interface TaskComposerCardProps {
...
export function TaskComposerCard({
  ...
  return (
    <div
      className={`relative bg-white dark:bg-neutral-700/50 border border-neutral-500/15 dark:border-neutral-500/15 rounded-2xl transition-all ${className ?? ""}`}
    >
      <DashboardInput
        ref={editorApiRef}
