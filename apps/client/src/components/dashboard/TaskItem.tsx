...
export const TaskItem = memo(function TaskItem({
  ...
  const workspaceRunId = runWithVSCode?._id;
  const shouldLinkToVSCode =
    Boolean(task.isLocalWorkspace) && Boolean(workspaceRunId);
  const taskLinkClassName = clsx(
