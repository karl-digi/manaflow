  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "bg-primary text-primary-foreground z-[var(--z-tooltip,10020)] w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md px-3 py-1.5 text-xs text-balance pointer-events-none select-none will-change-[transform,opacity]",
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="bg-primary fill-primary z-[var(--z-tooltip,10020)] size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] pointer-events-none select-none" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
