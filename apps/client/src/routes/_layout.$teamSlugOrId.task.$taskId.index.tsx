      ...
      <div className="flex h-full flex-col items-center justify-center gap-4 p-4">
        {availablePanels.length > 0 ? (
          <>
            ...
            <div className="w-full max-w-xs rounded-lg border border-neutral-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
              {availablePanels.map((panelType) => (
                <button
                  key={panelType}
                  type="button"
                  onClick={() => onAddPanel(position, panelType)}
                  className="flex w-full items-center gap-3 px-4 py-2 text-left text-sm text-neutral-700 hover:bg-neutral-100 first:rounded-t-lg last:rounded-b-lg transition-colors dark:text-neutral-200 dark:hover:bg-neutral-700"
                >
