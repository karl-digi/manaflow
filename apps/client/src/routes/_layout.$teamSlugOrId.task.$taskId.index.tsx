      ...
      <div className="flex h-full items-center justify-center p-4">
        {availablePanels.length > 0 ? (
          <div className="flex flex-col gap-2 w-full max-w-xs">
            <p className="text-xs font-medium text-neutral-600 dark:text-neutral-400 text-center mb-1">
              Add Panel
            </p>
            {availablePanels.map((panelType) => (
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-lg border border-neutral-300 bg-white text-neutral-700 hover:bg-neutral-100 hover:border-neutral-400 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:hover:border-neutral-500 transition-colors"
              >
                <div className="flex size-6 items-center justify-center rounded-full bg-neutral-200 text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
                  {getPanelIcon(panelType)}
                </div>
                <span className="text-sm font-medium">{PANEL_LABELS[panelType]}</span>
              </button>
            ))}
          </div>
        ) : (
