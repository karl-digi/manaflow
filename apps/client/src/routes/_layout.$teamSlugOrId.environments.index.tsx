          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {pendingEnvironments.map((pending) => {
              ...
              return (
                <div
                  key={pending.id}
                  className="flex h-full flex-col rounded-lg border border-neutral-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950"
                >
                  <div className="flex items-center justify-between gap-2">
                    <span className="inline-flex items-center rounded-full bg-neutral-100 px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-neutral-600 dark:bg-neutral-900 dark:text-neutral-400">
                      draft
                    </span>
                  </div>
                  <div className="mt-3">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-3 text-xs text-neutral-500 dark:text-neutral-400">
                      ...
                      <span className="inline-flex items-center gap-1">
                        ...
                        {pending.selectedRepos.length} repo
                        {pending.selectedRepos.length === 1 ? "" : "s"}
                      </span>
                      <span className="inline-flex items-center gap-1">
                        {pendingStepLabel}
                      </span>
