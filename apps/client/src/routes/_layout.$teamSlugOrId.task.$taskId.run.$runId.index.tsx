    ...
    void (async () => {
      ...
      if (result) {
        ...
        void preloadTaskRunIframes([
          {
            url: workspaceUrl
              ? toProxyWorkspaceUrl(workspaceUrl, localServeWeb.baseUrl, isLocalWorkspace)
              : "",
...
function TaskRunComponent() {
  ...
  const workspaceUrl = rawWorkspaceUrl
    ? toProxyWorkspaceUrl(rawWorkspaceUrl, localServeWeb.data?.baseUrl, isLocalWorkspace)
    : null;
