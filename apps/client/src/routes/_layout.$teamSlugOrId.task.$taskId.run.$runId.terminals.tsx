            ...
            {terminalIds.length > 0 ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center justify-center rounded-md p-1.5 text-xs font-medium text-neutral-600 transition-colors hover:bg-neutral-200/70 hover:text-neutral-900 disabled:cursor-not-allowed disabled:opacity-60 dark:text-neutral-400 dark:hover:bg-neutral-800/60 dark:hover:text-neutral-100"
