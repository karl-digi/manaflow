  ...
  const renderTerminalArea = () => {
    ...
    return (
      <div className="flex flex-col grow min-h-0">
        <div className="flex items-center justify-between gap-3 border-b border-neutral-200 bg-neutral-100/70 px-3 dark:border-neutral-800 dark:bg-neutral-900">
                  ...
                  <div key={id} className="relative pr-2">
                    <button
                      ...
                      className={clsx(
                        ...
                        isActive
                          ...
                          : "bg-transparent text-neutral-600 hover:bg-neutral-200/70 hover:text-neutral-900 dark:bg-neutral-800/40 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:hover:text-neutral-50"
                      )}
                      title={id}
                    >
                      <span
                    ...
                    <button
                      ...
                      className={clsx(
                        ...
                        isActive
                          ? "text-neutral-100 hover:text-neutral-50 hover:bg-neutral-900/80 dark:text-neutral-200 dark:hover:text-neutral-50 dark:hover:bg-neutral-700"
                          : "text-neutral-500 hover:text-neutral-900 hover:bg-neutral-300 dark:text-neutral-300 dark:hover:text-neutral-50 dark:hover:bg-neutral-700"
                      )}
