...
await $`bun build ./packages/cmux/src/cli.ts --compile --define VERSION="\"${VERSION}\"" --define process.env.WORKER_IMAGE_NAME="\"docker.io/karl8080/cmux:${VERSION}\"" --define process.env.NODE_ENV="\"production\"" --outfile cmux-cli --target bun`;
