...
const OPENCODE_CLI = "opencode-ai@latest";

const getOpencodeArgs = (model: string): string[] => [
  OPENCODE_CLI,
  "--hostname",
  OPENCODE_HOSTNAME,
  "--port",
  OPENCODE_PORT.toString(),
  "--prompt",
  "$PROMPT",
  "--model",
  model,
...
export const OPENCODE_GROK_CODE_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("opencode/grok-code"),
...
export const OPENCODE_SONNET_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("anthropic/claude-sonnet-4-20250514"),
...
export const OPENCODE_OPUS_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("anthropic/claude-opus-4-20250514"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [ANTHROPIC_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_KIMI_K2_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openrouter/moonshotai/kimi-k2"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
...
export const OPENCODE_QWEN3_CODER_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openrouter/qwen/qwen3-coder"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [ANTHROPIC_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_GLM_Z1_32B_FREE_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openrouter/z-ai/glm-4.5"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [OPENROUTER_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_O3_PRO_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openai/o3-pro"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
...
export const OPENCODE_GPT_5_CONFIG: AgentConfig = {
  name: "opencode/gpt-5",
  command: "bunx",
  args: getOpencodeArgs("openai/gpt-5"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [OPENAI_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_GPT_5_MINI_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openai/gpt-5-mini"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [OPENAI_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_GPT_5_NANO_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openai/gpt-5-nano"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [OPENAI_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_GPT_OSS_120B_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openrouter/openai/gpt-oss-120b"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [OPENROUTER_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_GPT_OSS_20B_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("openrouter/openai/gpt-oss-20b"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [OPENROUTER_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
...
export const OPENCODE_OPUS_4_1_20250805_CONFIG: AgentConfig = {
  ...
  command: "bunx",
  args: getOpencodeArgs("anthropic/claude-opus-4-1-20250805"),
  environment: getOpencodeEnvironment,
  checkRequirements: checkOpencodeRequirements,
  apiKeys: [ANTHROPIC_API_KEY],
  completionDetector: startOpenCodeCompletionDetector,
