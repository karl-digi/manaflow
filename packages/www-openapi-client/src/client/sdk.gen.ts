 ...
 */
export const postApiEnvironmentsRunMaintenance = <ThrowOnError extends boolean = false>(options: Options<PostApiEnvironmentsRunMaintenanceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiEnvironmentsRunMaintenanceResponses, PostApiEnvironmentsRunMaintenanceErrors, ThrowOnError>({
