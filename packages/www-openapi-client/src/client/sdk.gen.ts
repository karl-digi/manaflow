 ...
 */
export const postApiEnvironmentsRefreshAll = <ThrowOnError extends boolean = false>(options: Options<PostApiEnvironmentsRefreshAllData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiEnvironmentsRefreshAllResponses, PostApiEnvironmentsRefreshAllErrors, ThrowOnError>({
