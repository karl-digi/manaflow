...
/**
 * Force-resume the Morph VM associated with a task run
 */
export const postApiMorphTaskRunsByTaskRunIdForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphTaskRunsByTaskRunIdForceWakeResponses, PostApiMorphTaskRunsByTaskRunIdForceWakeErrors, ThrowOnError>({
