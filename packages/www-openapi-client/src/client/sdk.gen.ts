 ...
 */
export const postApiTaskRunsForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiTaskRunsForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTaskRunsForceWakeResponses, PostApiTaskRunsForceWakeErrors, ThrowOnError>({
