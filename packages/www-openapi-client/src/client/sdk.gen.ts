...
/**
 * Check GitHub mergeability for one or more pull requests
 */
export const postApiIntegrationsGithubPrsMergeability = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsMergeabilityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsMergeabilityResponses, PostApiIntegrationsGithubPrsMergeabilityErrors, ThrowOnError>({
