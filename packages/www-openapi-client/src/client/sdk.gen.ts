 ...
 */
export const postApiSandboxesByIdRehydrate = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesByIdRehydrateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesByIdRehydrateResponses, PostApiSandboxesByIdRehydrateErrors, ThrowOnError>({
