 ...
 */
export const postApiTaskRunsByTaskRunIdForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiTaskRunsByTaskRunIdForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTaskRunsByTaskRunIdForceWakeResponses, PostApiTaskRunsByTaskRunIdForceWakeErrors, ThrowOnError>({
