 ...
 */
export const postApiMorphTaskRunsForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphTaskRunsForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphTaskRunsForceWakeResponses, PostApiMorphTaskRunsForceWakeErrors, ThrowOnError>({
