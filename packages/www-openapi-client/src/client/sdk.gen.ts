 ...
 */
export const getApiScriptsByScriptName = <ThrowOnError extends boolean = false>(options: Options<GetApiScriptsByScriptNameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiScriptsByScriptNameResponses, GetApiScriptsByScriptNameErrors, ThrowOnError>({
