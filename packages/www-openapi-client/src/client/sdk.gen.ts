 ...
 */
export const postApiCodeReviewCallback = <ThrowOnError extends boolean = false>(options: Options<PostApiCodeReviewCallbackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiCodeReviewCallbackResponses, PostApiCodeReviewCallbackErrors, ThrowOnError>({
