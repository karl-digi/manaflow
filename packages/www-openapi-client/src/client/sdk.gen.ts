 ...
 */
export const postApiTaskrunForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiTaskrunForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).sse.post<PostApiTaskrunForceWakeResponses, PostApiTaskrunForceWakeErrors, ThrowOnError>({
