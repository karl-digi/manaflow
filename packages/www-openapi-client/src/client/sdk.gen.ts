...
/**
 * Resume a Morph workspace linked to a task run
 */
export const postApiSandboxesForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesForceWakeResponses, PostApiSandboxesForceWakeErrors, ThrowOnError>({
