 ...
 * List ACP threads
 */
export const getApiAcp = <ThrowOnError extends boolean = false>(options?: Options<GetApiAcpData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiAcpResponses, GetApiAcpErrors, ThrowOnError>({
        url: '/api/acp',
        ...options
    });
};
 ...
 * Create ACP thread
 */
export const postApiAcpNew = <ThrowOnError extends boolean = false>(options: Options<PostApiAcpNewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiAcpNewResponses, PostApiAcpNewErrors, ThrowOnError>({
        url: '/api/acp/new',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const postApiAcpStart = <ThrowOnError extends boolean = false>(options: Options<PostApiAcpStartData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiAcpStartResponses, PostApiAcpStartErrors, ThrowOnError>({
        url: '/api/acp/start',
        ...options,
        headers: {
            'Content-Type': 'application/json',
