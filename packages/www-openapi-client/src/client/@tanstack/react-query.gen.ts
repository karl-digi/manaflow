...
/**
 * Force wake the Morph VM that backs a task run
 */
export const postApiTaskRunsByTaskRunIdForceWakeMutation = (options?: Partial<Options<PostApiTaskRunsByTaskRunIdForceWakeData>>): UseMutationOptions<PostApiTaskRunsByTaskRunIdForceWakeResponse, DefaultError, Options<PostApiTaskRunsByTaskRunIdForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiTaskRunsByTaskRunIdForceWakeResponse, DefaultError, Options<PostApiTaskRunsByTaskRunIdForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiTaskRunsByTaskRunIdForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
