 ...
 */
export const postApiMorphTaskRunsForceWakeMutation = (options?: Partial<Options<PostApiMorphTaskRunsForceWakeData>>): UseMutationOptions<PostApiMorphTaskRunsForceWakeResponse, PostApiMorphTaskRunsForceWakeError, Options<PostApiMorphTaskRunsForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsForceWakeResponse, PostApiMorphTaskRunsForceWakeError, Options<PostApiMorphTaskRunsForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphTaskRunsForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
