 ...
 */
export const postApiIntegrationsGithubPrsMergeabilityMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsMergeabilityData>>): UseMutationOptions<PostApiIntegrationsGithubPrsMergeabilityResponse, DefaultError, Options<PostApiIntegrationsGithubPrsMergeabilityData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsMergeabilityResponse, DefaultError, Options<PostApiIntegrationsGithubPrsMergeabilityData>> = {
        mutationFn: async (fnOptions) => {
