...
/**
 * Re-hydrate a sandbox workspace (git pull to ensure /root/workspace exists)
 */
export const postApiSandboxesByIdRehydrateMutation = (options?: Partial<Options<PostApiSandboxesByIdRehydrateData>>): UseMutationOptions<PostApiSandboxesByIdRehydrateResponse, DefaultError, Options<PostApiSandboxesByIdRehydrateData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesByIdRehydrateResponse, DefaultError, Options<PostApiSandboxesByIdRehydrateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesByIdRehydrate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
