 ...
 */
export const postApiSandboxesForceWakeMutation = (options?: Partial<Options<PostApiSandboxesForceWakeData>>): UseMutationOptions<PostApiSandboxesForceWakeResponse, DefaultError, Options<PostApiSandboxesForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesForceWakeResponse, DefaultError, Options<PostApiSandboxesForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
