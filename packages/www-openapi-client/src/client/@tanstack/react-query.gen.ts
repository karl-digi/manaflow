...
/**
 * Force resume the Morph VM backing a task run workspace
 */
export const postApiTaskRunsForceWakeMutation = (options?: Partial<Options<PostApiTaskRunsForceWakeData>>): UseMutationOptions<PostApiTaskRunsForceWakeResponse, DefaultError, Options<PostApiTaskRunsForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiTaskRunsForceWakeResponse, DefaultError, Options<PostApiTaskRunsForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiTaskRunsForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
