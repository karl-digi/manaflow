...
/**
 * Start or continue a Plan Mode conversation
 */
export const postApiPlanChatMutation = (options?: Partial<Options<PostApiPlanChatData>>): UseMutationOptions<PostApiPlanChatResponse, DefaultError, Options<PostApiPlanChatData>> => {
    const mutationOptions: UseMutationOptions<PostApiPlanChatResponse, DefaultError, Options<PostApiPlanChatData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiPlanChat({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
