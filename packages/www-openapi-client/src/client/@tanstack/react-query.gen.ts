 ...
 */
export const postApiMorphTaskRunsForceWakeMutation = (options?: Partial<Options<PostApiMorphTaskRunsForceWakeData>>): UseMutationOptions<PostApiMorphTaskRunsForceWakeResponse, DefaultError, Options<PostApiMorphTaskRunsForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsForceWakeResponse, DefaultError, Options<PostApiMorphTaskRunsForceWakeData>> = {
        mutationFn: async (fnOptions) => {
