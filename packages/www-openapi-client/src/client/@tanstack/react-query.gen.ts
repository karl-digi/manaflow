...
/**
 * Force wake a paused Morph VM for a task run
 */
export const postApiTaskrunForceWakeMutation = (options?: Partial<Options<PostApiTaskrunForceWakeData>>): UseMutationOptions<PostApiTaskrunForceWakeResponse, DefaultError, Options<PostApiTaskrunForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiTaskrunForceWakeResponse, DefaultError, Options<PostApiTaskrunForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiTaskrunForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
