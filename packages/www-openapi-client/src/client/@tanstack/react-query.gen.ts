...
export const getApiAcpQueryKey = (options?: Options<GetApiAcpData>) => createQueryKey('getApiAcp', options);

/**
 * List ACP threads
 */
export const getApiAcpOptions = (options?: Options<GetApiAcpData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiAcp({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiAcpQueryKey(options)
    });
};
 ...
 * Create ACP thread
 */
export const postApiAcpNewMutation = (options?: Partial<Options<PostApiAcpNewData>>): UseMutationOptions<PostApiAcpNewResponse, PostApiAcpNewError, Options<PostApiAcpNewData>> => {
    const mutationOptions: UseMutationOptions<PostApiAcpNewResponse, PostApiAcpNewError, Options<PostApiAcpNewData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiAcpNew({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Start ACP session on worker
 */
export const postApiAcpStartMutation = (options?: Partial<Options<PostApiAcpStartData>>): UseMutationOptions<PostApiAcpStartResponse, PostApiAcpStartError, Options<PostApiAcpStartData>> => {
    const mutationOptions: UseMutationOptions<PostApiAcpStartResponse, PostApiAcpStartError, Options<PostApiAcpStartData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiAcpStart({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
