...
export const getApiIntegrationsGithubBranchesInfiniteOptions = (options: Options<GetApiIntegrationsGithubBranchesData>) => {
    return infiniteQueryOptions<GetApiIntegrationsGithubBranchesResponse, DefaultError, InfiniteData<GetApiIntegrationsGithubBranchesResponse>, QueryKey<Options<GetApiIntegrationsGithubBranchesData>>, number | Pick<QueryKey<Options<GetApiIntegrationsGithubBranchesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
