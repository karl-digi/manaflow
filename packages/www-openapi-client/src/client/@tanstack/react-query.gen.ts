...
/**
 * Refresh all environments with git pull, maintenance script, and new snapshot
 */
export const postApiEnvironmentsRefreshAllMutation = (options?: Partial<Options<PostApiEnvironmentsRefreshAllData>>): UseMutationOptions<PostApiEnvironmentsRefreshAllResponse, DefaultError, Options<PostApiEnvironmentsRefreshAllData>> => {
    const mutationOptions: UseMutationOptions<PostApiEnvironmentsRefreshAllResponse, DefaultError, Options<PostApiEnvironmentsRefreshAllData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiEnvironmentsRefreshAll({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
