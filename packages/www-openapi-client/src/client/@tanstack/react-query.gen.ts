 ...
 */
export const postApiEnvironmentsRunMaintenanceMutation = (options?: Partial<Options<PostApiEnvironmentsRunMaintenanceData>>): UseMutationOptions<PostApiEnvironmentsRunMaintenanceResponse, DefaultError, Options<PostApiEnvironmentsRunMaintenanceData>> => {
    const mutationOptions: UseMutationOptions<PostApiEnvironmentsRunMaintenanceResponse, DefaultError, Options<PostApiEnvironmentsRunMaintenanceData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiEnvironmentsRunMaintenance({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
