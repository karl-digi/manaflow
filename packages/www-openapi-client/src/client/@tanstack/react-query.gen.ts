...
export const getApiMorphCliCredentialsQueryKey = (options?: Options<GetApiMorphCliCredentialsData>) => createQueryKey('getApiMorphCliCredentials', options);
...
export const getApiMorphCliCredentialsOptions = (options?: Options<GetApiMorphCliCredentialsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiMorphCliCredentials({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiMorphCliCredentialsQueryKey(options)
    });
};
