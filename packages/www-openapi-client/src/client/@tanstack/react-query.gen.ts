...
/**
 * Callback endpoint for automated code review runner
 */
export const postApiCodeReviewCallbackMutation = (options?: Partial<Options<PostApiCodeReviewCallbackData>>): UseMutationOptions<unknown, DefaultError, Options<PostApiCodeReviewCallbackData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostApiCodeReviewCallbackData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiCodeReviewCallback({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
