 ...
 */
export const postApiMorphTaskRunsByTaskRunIdForceWakeMutation = (options?: Partial<Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData>>): UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdForceWakeResponse, PostApiMorphTaskRunsByTaskRunIdForceWakeError, Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdForceWakeResponse, PostApiMorphTaskRunsByTaskRunIdForceWakeError, Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphTaskRunsByTaskRunIdForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
