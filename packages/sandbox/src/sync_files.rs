...
pub const SYNC_FILES: &[SyncFileDef] = &[
    ...
    SyncFileDef {
        name: "VSCode Settings (Linux)",
        host_path: ".config/Code/User/settings.json",
        sandbox_path: "/root/.openvscode-server/data/User/settings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "VSCode Keybindings (Linux)",
        host_path: ".config/Code/User/keybindings.json",
        sandbox_path: "/root/.openvscode-server/data/User/keybindings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "VSCode Snippets (Linux)",
        host_path: ".config/Code/User/snippets",
        sandbox_path: "/root/.openvscode-server/data/User/snippets",
        is_dir: true,
    },
    // VS Code settings (macOS path)
    SyncFileDef {
        name: "VSCode Settings (macOS)",
        host_path: "Library/Application Support/Code/User/settings.json",
        sandbox_path: "/root/.openvscode-server/data/User/settings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "VSCode Keybindings (macOS)",
        host_path: "Library/Application Support/Code/User/keybindings.json",
        sandbox_path: "/root/.openvscode-server/data/User/keybindings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "VSCode Snippets (macOS)",
        host_path: "Library/Application Support/Code/User/snippets",
        sandbox_path: "/root/.openvscode-server/data/User/snippets",
        is_dir: true,
    },
    // Cursor settings (Linux path)
    SyncFileDef {
        name: "Cursor Settings (Linux)",
        host_path: ".config/Cursor/User/settings.json",
        sandbox_path: "/root/.openvscode-server/data/User/settings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Cursor Keybindings (Linux)",
        host_path: ".config/Cursor/User/keybindings.json",
        sandbox_path: "/root/.openvscode-server/data/User/keybindings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Cursor Snippets (Linux)",
        host_path: ".config/Cursor/User/snippets",
        sandbox_path: "/root/.openvscode-server/data/User/snippets",
        is_dir: true,
    },
    // Cursor settings (macOS path)
    SyncFileDef {
        name: "Cursor Settings (macOS)",
        host_path: "Library/Application Support/Cursor/User/settings.json",
        sandbox_path: "/root/.openvscode-server/data/User/settings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Cursor Keybindings (macOS)",
        host_path: "Library/Application Support/Cursor/User/keybindings.json",
        sandbox_path: "/root/.openvscode-server/data/User/keybindings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Cursor Snippets (macOS)",
        host_path: "Library/Application Support/Cursor/User/snippets",
        sandbox_path: "/root/.openvscode-server/data/User/snippets",
        is_dir: true,
    },
    // Windsurf settings (Linux path)
    SyncFileDef {
        name: "Windsurf Settings (Linux)",
        host_path: ".config/Windsurf/User/settings.json",
        sandbox_path: "/root/.openvscode-server/data/User/settings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Windsurf Keybindings (Linux)",
        host_path: ".config/Windsurf/User/keybindings.json",
        sandbox_path: "/root/.openvscode-server/data/User/keybindings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Windsurf Snippets (Linux)",
        host_path: ".config/Windsurf/User/snippets",
        sandbox_path: "/root/.openvscode-server/data/User/snippets",
        is_dir: true,
    },
    // Windsurf settings (macOS path)
    SyncFileDef {
        name: "Windsurf Settings (macOS)",
        host_path: "Library/Application Support/Windsurf/User/settings.json",
        sandbox_path: "/root/.openvscode-server/data/User/settings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Windsurf Keybindings (macOS)",
        host_path: "Library/Application Support/Windsurf/User/keybindings.json",
        sandbox_path: "/root/.openvscode-server/data/User/keybindings.json",
        is_dir: false,
    },
    SyncFileDef {
        name: "Windsurf Snippets (macOS)",
        host_path: "Library/Application Support/Windsurf/User/snippets",
        sandbox_path: "/root/.openvscode-server/data/User/snippets",
        is_dir: true,
    },
];
